    ...
    <div class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Commit a new activity to your professional log</p>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4 p-md-5">
                <form action="<?= base_url('admin/aktivitas/save'); ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" class="form-control rounded-end-3 py-2 <?= ($validation->hasError('tanggal')) ? 'is-invalid' : ''; ?>" id="tanggal" name="tanggal" value="<?= old('tanggal') ? old('tanggal') : date('Y-m-d'); ?>">
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-3 py-2 <?= ($validation->hasError('nama_aktivitas')) ? 'is-invalid' : ''; ?>" id="nama_aktivitas" name="nama_aktivitas" value="<?= old('nama_aktivitas'); ?>" placeholder="Contoh: Mengembangkan Modul Auth">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control rounded-4 py-2 <?= ($validation->hasError('keterangan')) ? 'is-invalid' : ''; ?>" id="keterangan" name="keterangan" rows="5" placeholder="Jelaskan apa yang Anda kerjakan atau capai..."><?= old('keterangan'); ?></textarea>
