    ...
    <div class="col-lg-8">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Modify an existing educational history record</p>
            </div>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4 p-md-5">
                <form action="<?= base_url('admin/pendidikan/update/' . $pendidikan['id']); ?>" method="post">
                    <?= csrf_field(); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select rounded-3 py-2 <?= ($validation->hasError('jenjang')) ? 'is-invalid' : ''; ?>" id="jenjang" name="jenjang">
                            ...
                            <option value="SD" <?= (old('jenjang') ? old('jenjang') : $pendidikan['jenjang']) == 'SD' ? 'selected' : ''; ?>>SD / Sederajat</option>
                            <option value="SMP" <?= (old('jenjang') ? old('jenjang') : $pendidikan['jenjang']) == 'SMP' ? 'selected' : ''; ?>>SMP / Sederajat</option>
                            <option value="SMA" <?= (old('jenjang') ? old('jenjang') : $pendidikan['jenjang']) == 'SMA' ? 'selected' : ''; ?>>SMA / SMK / Sederajat</option>
                            <option value="Kuliah" <?= (old('jenjang') ? old('jenjang') : $pendidikan['jenjang']) == 'Kuliah' ? 'selected' : ''; ?>>Perguruan Tinggi</option>
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control rounded-3 py-2 <?= ($validation->hasError('nama_sekolah')) ? 'is-invalid' : ''; ?>" id="nama_sekolah" name="nama_sekolah" value="<?= old('nama_sekolah') ? old('nama_sekolah') : $pendidikan['nama_sekolah']; ?>" placeholder="Contoh: Universitas Gadjah Mada">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control bg-light border-start-0 py-2 <?= ($validation->hasError('tahun_masuk')) ? 'is-invalid' : ''; ?>" id="tahun_masuk" name="tahun_masuk" value="<?= old('tahun_masuk') ? old('tahun_masuk') : $pendidikan['tahun_masuk']; ?>" placeholder="Contoh: 2020">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control bg-light border-start-0 py-2 <?= ($validation->hasError('tahun_lulus')) ? 'is-invalid' : ''; ?>" id="tahun_lulus" name="tahun_lulus" value="<?= old('tahun_lulus') ? old('tahun_lulus') : $pendidikan['tahun_lulus']; ?>" placeholder="Contoh: 2024">
                            </div>
